...
## The mean with the missing data removed is `r newstepsmean` and with the missing data is `r stepsmean`.
## The meadian with the missing data removed is `r newstepsmedian` and with the missing data is `r stepsmedian`.
